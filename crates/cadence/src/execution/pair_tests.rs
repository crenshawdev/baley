...
use super::{
    ...
    receipts::{
        ...
        RunResult, Stage, Summary, validate_pairs,
    },
};
use serde_json::{Value, json};

const RED: &str = "1111111111111111111111111111111111111111";
const GREEN: &str = "2222222222222222222222222222222222222222";
const DONE: &str = "3333333333333333333333333333333333333333";
const TEST_FILE: &str = "crates/cadence/src/delivery.rs";
const TEST_DIGEST: &str = "digest-of-the-test";
const RED_TREE: &str = "tree-at-red";
const GREEN_TREE: &str = "tree-at-green";
const COMMAND: &str = "cargo nextest run delivery";
...
fn allocating(checks: &[&str]) -> Value {
...
fn material(commit: &str, tree: &str) -> Material {
    Material {
        commit: commit.into(),
        tree: tree.into(),
...
fn record(attempt: &str, id: &str, event: Event) -> Record {
    Record {
...
fn launch(attempt: &str, run: &str, id: &str, stage: Stage, commit: &str, tree: &str, at: u64) -> Record {
...
fn result(attempt: &str, run: &str, code: i32, at: u64) -> Record {
...
fn honest_records(id: &str) -> Vec<Record> {
...
fn honest_facts() -> RepositoryFacts {
    RepositoryFacts::new()
        .ancestor(RED, GREEN)
        .ancestor(GREEN, DONE)
