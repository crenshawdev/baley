...
// CADENCE-CENSUS: self-verify-merge-layers | asserts: eighteen mergeLayers callsites over thirteen files, each in one of the two warning-surfacing arms
test('check 12: the live tree is EIGHTEEN callsites over THIRTEEN files, each in an arm', () => {
  ...
  // files. Removing the frozen publishing helper leaves eighteen over thirteen.
