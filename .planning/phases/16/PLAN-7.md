...
Answer help from one compiled command table and use that table for installed skill descriptions.
  ...
  "items": [
    ...
    },
    {
      ...
      "spec": {
        ...
        "substance": "Compiled name/cluster/description table for exactly 27 installed user-invocable skills; pure help query lists clusters, normalizes slash/cad- prefixes and returns closest names for no match. No runtime COMMANDS.md read, no invented absent commands."
      },
